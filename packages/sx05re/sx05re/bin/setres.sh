...
case "$MODE" in
"480p60hz")
	fbset -fb /dev/$FB -g 720 480 720 960 $BPP
	;;
"576p50hz")
	fbset -fb /dev/$FB -g 720 576 720 1152 $BPP
	;;
"720p60hz")
	fbset -fb /dev/$FB -g 1280 720 1280 1440 $BPP
	;;
"720p50hz")
	...
	;;
"1080p60hz")
	fbset -fb /dev/$FB -g 1920 1080 1920 2160 $BPP
	;;
"1080i60hz")
	fbset -fb /dev/$FB -g 1920 1080 1920 2160 $BPP
	;;
...
"1080p50hz")
	...
	;;
"480cvbs")
	fbset -fb /dev/$FB -g 1280 960 1280 1920 $BPP
